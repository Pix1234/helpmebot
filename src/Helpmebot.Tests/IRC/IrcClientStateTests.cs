...
namespace Helpmebot.Tests.IRC
{
    ...
    public class IrcClientStateTests : TestBase
    {
        ...
        {
            Mock<SupportHelper> supportMock = new Mock<SupportHelper>();
            ...
            this.client = new IrcClient(this.networkClient.Object, this.Logger.Object, this.IrcConfiguration.Object, "pw", supportMock.Object);
        }
