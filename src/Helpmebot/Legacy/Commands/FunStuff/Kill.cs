// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Kill.cs" company="Helpmebot Development Team">
...
namespace helpmebot6.Commands
{
    ...
    /// The kill.
    /// </summary>
    internal class Kill : ProtectedTargetedFunCommand
    {
        /// <summary>
        /// Initialises a new instance of the <see cref="Kill"/> class.
        /// </summary>
        /// <param name="source">
        /// The source.
        /// </param>
