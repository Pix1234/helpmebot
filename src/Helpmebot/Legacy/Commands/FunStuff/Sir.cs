// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Sir.cs" company="Helpmebot Development Team">
...
namespace helpmebot6.Commands
{
    ...
    /// The Sir.
    /// </summary>
    internal class Sir : ProtectedTargetedFunCommand
    {
        /// <summary>
        /// Initialises a new instance of the <see cref="Sir"/> class.
        /// </summary>
        /// <param name="source">
        /// The source.
        /// </param>
